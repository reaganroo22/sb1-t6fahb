...
import { Heart, X, Star, Info, Camera, Flag } from 'lucide-react';
import { motion, useAnimation } from 'framer-motion';
import { getRandomProfile } from '../services/mockDataService';
        ...
        {showDetails && (
          <div className="border-t pt-4">
            ...
            <div className="flex items-center mb-2">
              ...
              <span>Compatibility Score: {currentProfile.compatibilityScore}%</span>
            </div>
            {subscription !== 'free' && (
              <div>
                <h3 className="font-semibold mb-2">Premium Features</h3>
                <button className="bg-pink-500 text-white py-2 px-4 rounded-md hover:bg-pink-600 transition duration-300 mr-2">
                  <Camera size={16} className="inline-block mr-1" /> Request More Photos
                </button>
                <button className="bg-gray-500 text-white py-2 px-4 rounded-md hover:bg-gray-600 transition duration-300">
                  <Flag size={16} className="inline-block mr-1" /> Report Profile
                </button>
              </div>
            )}
          </div>
